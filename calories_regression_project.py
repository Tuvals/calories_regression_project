# -*- coding: utf-8 -*-
"""calories_regression_project.ipynb
...
#     # diff_score = [j-i for i,j in zip(test_scores,train_scores)]
#     knn_n.append(i)
# plt.figure(figsize=[10,5])
# plt.plot(knn_n, train_scores, label = 'Train Score')
# plt.plot(knn_n, test_scores, label = 'Test Score')

# # plt.plot(knn_n, diff_score, label = 'Difference Score')

# plt.legend()
# plt.title('Score by # of Neighbours')
# plt.xlabel('Neighbors')
# plt.ylabel('Score')
# plt.xticks(knn_n)
# plt.show()
...
#     # rmsle
#     rmsle_test.append(rmsle(y_test, y_test_pred))
#     rmsle_train.append(rmsle(y_train, y_train_pred))

#     # train_scores.append(model.score(X_train, y_train))
#     # test_scores.append(model.score(X_test, y_test))
#     knn_n.append(i)
# plt.figure(figsize=[10,5])
# plt.plot(knn_n, rmsle_test, label = 'RMSLE Test')
# plt.plot(knn_n, rmsle_train, label = 'RMSLE Train')
# plt.legend()
# plt.title('Number of Neighbours')
# plt.xlabel('Neighbors')
# plt.ylabel('Loss')
...
# X = calories_exercise.drop(['Calories', 'Height'], axis=1)
# y = calories_exercise['Calories']
...
# # predict using the validate sets
...
# print(f"rmsle valid = {rmsle_valid:.2f}")
# print(f"rmsle test = {rmsle_test:.2f}")
# print(f"rmsle train = {rmsle_train:.2f}")
